...
class BaselineProfileGenerator {
    ...
    private companion object {
        /**
         * The *release* applicationId. The debug build carries a `.debug`
         * suffix and is a separate app with separate data; profiles are
         * generated against the one that ships.
         */
        const val PACKAGE = "com.mdblisthub.tv"
